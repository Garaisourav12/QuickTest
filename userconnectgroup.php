      ...
      <div class="span8 offset3">
		<form action="" method="POST">
		  <div class="form-group" style="width: 100%; display: flex; justify-content: space-between;">
		    <label style="margin-right: 10px;">Group Token: </label>
		    <input type="text" class="form-control adgrfs" style="margin-right: 100px;" name="gtoken" required="1">
		  </div>
		  <div class="form-group hgad" style="width: 100%; display: flex; justify-content: space-between;">
		    <label style="margin-right: 10px;">Instructor Id: </label>
		    <input type="text" class="form-control adgrfs" style="margin-right: 100px;" name="insid" required="1">
		  </div>
		  <div class="form-group hgad" style="width: 100%; display: flex; justify-content: space-between;">
		    <label style="margin-right: 10px;">Name: </label>
		    <input type="text" class="form-control adgrfs" style="margin-right: 100px;" name="name"  placeholder="Full Name" required="1">
		  </div>
		  ...
		  <div class="form-group hgad" style="width: 100%; display: flex; justify-content: space-between;">
		    ...
		    <input type="text" class="form-control adgrfs" style="margin-right: 100px;" name="email" placeholder="Email Id">
		  </div>
		  <!-- <div class="form-group hgad">
