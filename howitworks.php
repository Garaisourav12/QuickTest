     ...
     <div class="span10 offset1 aboutp">
       <h2 style="margin-bottom: 15px;font-size: 30px;">Who Takes The Exam(Administrators):</h2>
        ...
        <p><strong>14. You can create & manage as many exam groups as you need.</strong></p>
         ...
         <p><strong>1. First you have to "Log In"  from 'Candidates' tab.</strong></p> 
        <p><strong>2. If you don't have any id,first you have to "Register" from "Candidates" tab & then 'Log In' from 'Candidates' tab.</strong></p>
