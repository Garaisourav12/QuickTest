...
<div class="container bg-light-gray">
        <div class="main-content">
          <div class="featured-heading">
              <h1>QuickTest Is a Professional Online Exam System</h1>
         ...
         <div class="featured-blocks">
          ...
          <div class="tabs">
              <ul id="myTabContent" class="nav nav-tabs">
                <li class="active"><a href="#vestibuluco" data-toggle="tab">Log In (Candidates)</a></li>
                <li class=""><a href="#loginadmin" data-toggle="tab">Log In (Administrators)</a></li>
                <li class=""><a href="#fuscelobin" data-toggle="tab">Register (Candidates)</a></li>
