   ...
   <div class="featured-content">
    ...
    ?>
	    <div class="row-fluid eachgr">
	      ...
	      <div class="span5">
	      <p><strong>Exam Time: </strong><span style="color:mintcream"><?php echo $dt1;?></span></p>
	      <p style="margin-top: -12px;"><strong>Current Time: </strong><span style="color:mintcream"><?php echo $st;?></span></p>
